...
Keycloak, JWT, roles nem IP de origem: os bloqueios acontecem no gateway, com
`AuthorizationPolicy` do Istio e `AuthPolicy` do Red Hat Connectivity Link
(RHCL), sem alteração do código da aplicação.
